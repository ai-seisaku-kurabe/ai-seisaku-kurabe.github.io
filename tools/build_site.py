...
ABOUT=(f'<title>このサイトについて（方法論と透明性）｜ AI政策くらべ</title>\n'
  ...
  '<p class="ab-b">「どの党を載せるか」は、恣意的に決めると中立性が崩れます。'
  ...
  '<div class="ab-limit"><p><b>これは3つの会期の断面です。</b>今後の会期で更新していきます。</p></div>''<div class="ab-limit"><p><b>先行研究が指摘していて、まだ解けていない問題があります。</b>設問の選び方が一致度を左右すること、一致度の計算式そのものが編集判断であること、記名投票が代表的な標本ではないことなど、現時点で手当てできていない点を<a class="src" href="research.html">▸ 先行研究と、この設計の根拠</a>の03に、根拠となる文献とともに列挙しています。</p></div></section>'
...
RESEARCH=(f'<title>先行研究と、この設計の根拠｜ AI政策くらべ</title>\n'
  ...
  + _rs("keep",
    ...
    "安全側に倒して止める設計にしています。",
    _cite("総務省 インターネット選挙運動の解説", "https://www.soumu.go.jp/senkyo/senkyo_s/naruhodo/naruhodo10.html"))
  ...
  + _rs("open",
    ...
    "衆議院が起立採決のため個人別の賛否が残らないことは公開していますが、"
    "<b>参議院の中でも記名投票にかかる議案が選ばれている</b>という点は、まだ明示していません。"
  ...
  '<li><b>公職選挙法の現行の法定刑表記。</b>2022年改正刑法により2025年6月1日から'
  '「禁錮」が「拘禁刑」に一本化されているため、第242条の2の表記が変わっている可能性があります。'
  'e-Gov で現行条文を確認できていません。</li>'
  '<li><b>会議録そのものの作られ方。</b>衆議院の会議録が音声認識をもとに作成されているという指摘があります。'
  '事実であれば「一次情報にも生成の過程がある」ことになり、限界として書くべき事柄です。'
  '一次資料で確認できていません。</li>'
  '<li><b>2026年5月27日の公職選挙法改正の骨子。</b>与野党9党が、実写と誤認されうるAI動画・画像への'
  '「AI作成」表示義務を含む骨子をまとめたと報じられました。'
  '骨子の段階ではテキストや集計は対象外に見えますが、条文化で変わりうるため追跡します。</li>'
  '</ul></div></section>'
