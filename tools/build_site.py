...
RESEARCH=(f'<title>先行研究と、この設計の根拠｜ AI政策くらべ</title>\n'
  ...
  '<div class="rs-unv"><ul>'
  '<li><b>2026年の公職選挙法改正。</b>選挙運動で使うAI生成物に「AI作成」の表示を義務づける改正が''2026年に成立したと報じられています。表示の対象は画像・映像に限られ、テキストや集計は含まれないとされますが、''<b>公布されたばかりで、私たちは条文そのものを確認できていません。</b>''確認できるまで、このサイトが対象外であるとは書きません''（なお、このサイトは画像も映像も生成していません）。</li>'
