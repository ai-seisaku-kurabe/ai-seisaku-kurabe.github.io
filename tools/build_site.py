...
ABOUT=(f'<title>このサイトについて（方法論と透明性）｜ AI政策くらべ</title>\n'
  ...
  '<div class="ab-limit"><p><b>これは3つの会期の断面です。</b>今後の会期で更新していきます。</p></div></section>'
